...
prefix="spring"%> <%@ taglib uri="http://java.sun.com/jsp/jstl/core"
prefix="c"%>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img
          ...
          src="${contextPath}/resources/assets/img/avataaars.svg"
          alt="..."
        />
        <!-- Masthead Heading-->
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/cabin.png"
                alt="..."
              />
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/cake.png"
                alt="..."
              />
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/circus.png"
                alt="..."
              />
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/game.png"
                alt="..."
              />
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/safe.png"
                alt="..."
              />
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              ...
              <img
                class="img-fluid"
                src="${contextPath}/resources/assets/img/portfolio/submarine.png"
                alt="..."
              />
            </div>
          </div>
